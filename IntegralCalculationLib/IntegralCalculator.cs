    ...
    public class IntegralCalculator
    {
        ...
        public void CalculateIntegral()
        {
            ...
            for (double x = a; x < b; x += step)
            {
                ...
                // Искусственная задержка для увеличения времени работы (как в задании).
        ...
        public void CalculateIntegralWithSync(int threadId)
        {
            ...
            try
            {
                // Пункт 5: Дополнительная блокировка, гарантирующая, что внутри
                // семафора критическую секцию выполняет только один поток.
                // Для чистоты эксперимента пункта 5, семафор должен быть на 1.
                lock (_lockObject)
                {
            ...
            {
                // Важно! Независимо от того, что произошло в блоке try,
                // мы ДОЛЖНЫ освободить слот в семафоре, чтобы другие потоки могли войти.
